...
public class SessionEditer extends AppCompatActivity {
    private  int classID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session_editer);
        ...
        if (getIntent().hasExtra("Session ID")){
            ...
            editStudents.setOnLongClickListener(v -> {
                Intent intent = new Intent(SessionEditer.this,EditSessionStudents.class);
